...
public class DoHooksCallBacks03 {
    private static Logger log = LoggerFactory.getLogger(DoHooksCallBacks03.class);

    // the code flows from subscribe to up and then down again. Thats why in logs sometime 2 is printed before 1
