...
public class OverFlowStrategy10 {
    private static Logger log = LoggerFactory.getLogger(OverFlowStrategy10.class);
    ...
    public static void main(String args[]) throws InterruptedException {
        ...
        var producer = Flux.create(
                ...
                .onBackpressureBuffer()   // if incase you want standard strategy for all the subscriber
                .subscribeOn(Schedulers.parallel());

        producer.onBackpressureBuffer(10).limitRate(1)
